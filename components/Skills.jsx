...
import mongodbImg from "../public/assets/mongodb.png";
import nodejsImg from "../public/assets/node.png";
import mysqlImg from "../public/assets/mysql.png";
import pythonImg from "../public/assets/python.png";
import javaAndroidImg from "../public/assets/javaAndroid.png";
      ...
      <div className='max-w-[1240px] mx-auto flex flex-col justify-center h-full'>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
          ...
          <div className='p-6 shadow-xl rounded-xl bg-white hover:scale-105 ease-in duration-300'>
            <div className='grid grid-cols-2 gap-4 justify-center items-center'>
              <div className='m-auto'>
                <Image src={phpImg} width='64px' height='64px' alt='/' />
              </div>
              <div className='flex flex-col items-center justify-center'>
                <h3>PHP</h3>
              </div>
          ...
          <div className='p-6 shadow-xl rounded-xl bg-white hover:scale-105 ease-in duration-300'>
            <div className='grid grid-cols-2 gap-4 justify-center items-center'>
              <div className='m-auto'>
                <Image src={materialUiImg} width='64px' height='64px' alt='/' />
              </div>
              <div className='flex flex-col items-center justify-center'>
                <h3>Material UI</h3>
              </div>
